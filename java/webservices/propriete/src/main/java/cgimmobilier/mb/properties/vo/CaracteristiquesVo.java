package cgimmobilier.mb.properties.vo;
 ...
 *
 */
public class CaracteristiquesVo {
	...
	public String toString() {
		return "CaracteristiquesVo [propertyId=" + propertyId + ", modeDeChauffage=" + modeDeChauffage + ", proximite="
				+ proximite + ", revetements=" + revetements + ", sousSol=" + sousSol + ", stationnement="
				+ stationnement + ", systemeEgout=" + systemeEgout + "]";
	}
