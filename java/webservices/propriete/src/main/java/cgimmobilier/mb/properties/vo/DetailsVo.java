...
public class DetailsVo {
	...
	public String toString() {
		return "DetailsVo [propertyId=" + propertyId + ", quartier=" + quartier + ", superficieHabitable="
				+ superficieHabitable + ", superficieTerrain=" + superficieTerrain + ", dateConstruction="
				+ dateConstruction + ", neuf=" + neuf + ", nbEtage=" + nbEtage + ", style=" + style + "]";
	}
